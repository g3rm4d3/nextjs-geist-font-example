 ...
 * recommended approach for auth flows. DriverProfileProvider wraps the
 * signed-in branch only, so GET /drivers/me/profile is fetched exactly
 * once a driver session exists, not before.
 */
        ...
        <Stack.Navigator screenOptions={SCREEN_OPTIONS}>
          {status === 'signedOut' ? (
            ...
            <>
              ...
              />
              <Stack.Screen name="Arrival" component={ArrivalScreen} options={{ title: 'Arrival' }} />
