 ...
 * screen, so registration doesn't depend on the driver ever visiting a
 * particular screen. Best-effort throughout: a failed or unavailable
 * push token never surfaces an error to the driver — see
