...
/**
 * A driver's own ticket, read-only: the current status and the full
...
const styles = StyleSheet.create({
  ...
  subject: { color: '#fafaf9', fontSize: 18, fontWeight: '700' },
  ...
  bubbleSelf: { backgroundColor: '#292524', alignSelf: 'flex-end' },
  bubbleSupport: { backgroundColor: '#44403c', alignSelf: 'flex-start' },
  bubbleAuthor: { color: '#a8a29e', fontSize: 11, fontWeight: '700', marginBottom: 4 },
  bubbleBody: { color: '#fafaf9', fontSize: 14 },
  bubbleMeta: { color: '#78716c', fontSize: 10, marginTop: 8 },
});
