 ...
 * ride reference is a manually-entered ride id rather than a picker
 * over past rides — this app has no "list my past rides" endpoint yet
 * (RideHistoryScreen is still a placeholder), and building one is out
 * of this phase's scope; see docs/support-system.md's known
 * limitations. The backend re-verifies server-side that any id entered
 * here actually belongs to the caller (section 3's server-authoritative
 * principle) — a wrong or someone-else's id is rejected with a clear
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        placeholder="e.g. I was charged the wrong fare"
      ...
      >
        {isSubmitting ? <ActivityIndicator color="#0f172a" /> : <Text style={styles.submitButtonText}>Submit</Text>}
      </Pressable>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  submitButtonText: { color: '#0f172a', fontSize: 15, fontWeight: '700' },
});
